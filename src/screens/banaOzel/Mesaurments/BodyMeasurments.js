...
const BodyMeasurments = ({exercisesData,DaysData, ...props }) => { 
    ...
    console.log('prop',props.prefix)
    
    const fetchBodyMasses=() =>{    
        _fetchData('BodyMass').then(response =>{  
...
const styles = StyleSheet.create({ 
  ...
  export default memo(BodyMeasurments);