...
const AddExercises = ({exercisesData,DaysData, ...props }) => {
  ...
  const [visibilty, setVisibility] = useState(false)
    ...
    <Item   style={styles.container}> 
        ...
        <View style={styles.Addcontainer}>
            <TouchableOpacity  onPress={()=>{setVisibility(true) } }>
                <Image
                  ...
                  tintColor={exercisesData[0]? null:'#E92C81'}
                  source={ exercisesData[0]?  require('../../assets/edit.png') : require('../../assets/plus.png')}
                  />
            </TouchableOpacity>
        </View> 
        ...
        <AddMealModal 
              ...
              title={'Egzersiz'}
              content = {exercisesData[0]?  exercisesData[0]['content'] : ''}
          /> 
