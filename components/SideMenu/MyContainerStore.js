...
const MyContainerStore = ({imagePlaceholder,headtext,type,prefix,firstcolor,secondcolor,price,date, ...props }) => { 
          ...
          <LinearGradient start={{x: 0, y: 0}} end={{x: 1, y: 0}}  colors={[firstcolor,secondcolor]} style={styles.container} onPress={()=>_handleNavigating(prefix)}> 
            ...
            <View >
              <Text style={styles.specification}>
                Satin Alma Tarihi :  {date.split(' ')[0]}
              </Text> 
            </View> 

            <View >
              <Text style={styles.specification}>
                Ödenmiş Tutarı :  {price} tl
              </Text> 
            </View> 
...
export default memo(MyContainerStore);