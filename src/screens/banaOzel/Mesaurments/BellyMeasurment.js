...
const BellyMeasurment = ({exercisesData,DaysData, ...props }) => { 
    ...
    const fetchBodyMasses=() =>{    
        _fetchData('WaistWidth').then(response =>{  
    ...
    const renderItem = ({ item,index }) => ( 
        ...
        <TouchableWithoutFeedback onPress={() => {true}}>
            ...
            <SwipeableContainer  
                ...
                title={'Bel Çevresi değerlendirme'}
                id = {list[index].id}
...
const styles = StyleSheet.create({ 
  ...
  export default memo(BellyMeasurment);